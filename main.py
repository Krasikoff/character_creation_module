...
def attack(char_name: str, char_class: str) -> str:
    """Сравнивает и возвращает величину урона, нанесеного противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Сравнивает и возвращает величину блокировки урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Сравнивает и возвращает величину специального умения."""
    if char_class == 'warrior':
        return (
...
def choice_char_class() -> str:
    """Игрок выбирает характер персонажа."""
    approve_choice: str = ''
    char_class: str = ''
